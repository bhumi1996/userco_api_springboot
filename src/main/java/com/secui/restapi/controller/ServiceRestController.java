...
public class ServiceRestController {
    ...
    @RequestMapping(value = RestUrlConstants.SERVICE_LIST,method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Map<String,Object>> getAllService(@PathVariable(value = RestConstantUtil.PORTAL) String portal,
        ...
        return serviceInterface.findAll(UtilHelper.pageable(page,size,searchMap.get(RestConstantUtil.SORT_BY),searchMap.get(RestConstantUtil.SORT_DIR)));
    }
