...
import com.secui.mvc.repository.PortalRepository;
...
public class PortalImpl implements PortalInterface {
    ...
    @Override
    public List<String> getActivePortal() {
        System.out.println(portalRepository.findAllByStatus(ConstantUtil.ACTIVE));
        return portalRepository.findAllByStatus(ConstantUtil.ACTIVE);
