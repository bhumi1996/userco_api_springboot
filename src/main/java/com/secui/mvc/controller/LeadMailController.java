...
public class LeadMailController implements InitBinderInterface {
    ...
    public String sendLeadMail(Model model, @PathVariable(ConstantUtil.LEAD_UKEY) String leaduKey,
        ...
        if (emailConfigurationResponseDto == null) {
            ...
            return UrlConstants.REDIRECT_LEAD+leaduKey+UrlConstants.LEAD_MAIL_URL;
        }
        ...
        System.out.println("Controller template "+emailTemplateResponseDto);
        if (emailTemplateResponseDto == null) {
        ...
        leadMailRequestDto.setTemplateName(emailTemplateResponseDto.getTemplateName());
